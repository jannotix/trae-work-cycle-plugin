...
const LEGACY_PROTOCOL_V1_REQUEST_AMENDMENT_DOMAIN: &str = "trae-workflow/request-amendment/v1";
const LEGACY_PROTOCOL_V1_REQUEST_DOMAIN: &str = "trae-workflow/request/v1";
